package br.tiagohm.markdownviewx.ext.twitter.internal;
...
import br.tiagohm.markdownviewx.Utils;
...
public class TwitterNodeRenderer implements NodeRenderer {
    ...
    public Set<NodeRenderingHandler<?>> getNodeRenderingHandlers() {
        ...
        set.add(new NodeRenderingHandler<>(Twitter.class, new NodeRenderingHandler.CustomNodeRenderer<Twitter>() {
            @Override
            public void render(@NotNull Twitter node, @NotNull NodeRendererContext context, @NotNull HtmlWriter html) {
